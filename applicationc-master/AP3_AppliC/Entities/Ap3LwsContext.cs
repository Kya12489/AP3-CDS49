...
public partial class Ap3LwsContext : DbContext
{
    public Ap3LwsContext()
    {
    }

    public Ap3LwsContext(DbContextOptions<Ap3LwsContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=192.168.10.16;port=3306;user=ap3_lws-1;password=QBk2eSrI;database=ap3_lws", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.4.1-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Admin>(entity =>
        {
            ...
            entity.HasIndex(e => e.LoginAdmin, "loginAdmin").IsUnique();
            ...
            entity.Property(e => e.PrenomAdmin)
                .HasMaxLength(128)
        ...
        modelBuilder.Entity<Eleve>(entity =>
        {
            ...
            entity.Property(e => e.Numeroteleleve)
                .HasMaxLength(20)
                .HasColumnName("numeroteleleve");
