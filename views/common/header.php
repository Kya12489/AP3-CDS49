        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <!-- FIN DE L'A PROPOS DANS LE HEADER  -->
                    ...
                    <?php } else { ?>
                        ...
                        <!-- Ajout de supprimer compte dans le menu LOT 1 -->
                        <li class="nav-item">
                            <a class="nav-link" href="/supprimer-compte.html">Supprimer mon compte</a>
                        </li>
                        <!-- Fin de l'ajout de supprimer compte dans le menu LOT 1 -->
                    <?php } ?>
                </ul>
            </div>
        </div>
