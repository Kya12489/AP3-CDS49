...
class Web
{
    function __construct()
    {
        ...
        // AJOUT DE L'A PROPOS DANS LE ROUTEUR  --- LOT 1 ---
        Route::Add('/about.html', [$public, 'about']);
        ...
        if (SessionHelpers::isLogin()) {
            ...
            // Ajout de la route supprimer compte --- LOT 1 ---
            Route::Add('/supprimer-compte.html', [$compte, 'supprimerCompte']);
            // Fin de l'ajout de la route supprimer compte --- LOT 1 ---
        }
